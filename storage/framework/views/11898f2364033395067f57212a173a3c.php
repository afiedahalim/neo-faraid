...
<body>
    ...
    <div class="alert-container" id="alert-container">
        ...
        <div class="alert-message alert-success" data-auto-dismiss="2000" data-redirect="<?php echo e(route('admin.users.index')); ?>">
            ...
            <div class="alert-content">
                <div class="alert-title">User Updated Successfully</div>
                <p>The user information has been updated successfully.</p>
                <p style="margin-top: 5px; font-size: 0.9rem; opacity: 0.9;">Redirecting to users list...</p>
            </div>
    ...
    <div class="confirmation-modal" id="confirmation-modal">
        <div class="confirmation-content">
            ...
            <p class="confirmation-message">
                Are you sure you want to update this user's information?<br>
    ...
    <main class="admin-main">
        ...
        <header class="page-header">
            <div class="page-title">
                <h1>Edit User</h1>
                <p class="page-subtitle">Update user details and settings</p>
            </div>
        </header>
        
        <!-- Form Container -->
        <div class="form-container">
            <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" id="edit-user-form">
                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="form-text text-error"><?php echo e($message); ?></div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        // Navigation Manager Class (Enhanced from reference code)
        ...
        class FormValidator {
            constructor(formId) {
                ...
                this.fields = {
                    ...
                    role: this.form.querySelectorAll('input[name="role"]'),
                    status: this.form.querySelectorAll('input[name="status"]')
                };
                this.errors = [];
                this.init();
            }
            ...
            init() {
                ...
                this.fields.role?.forEach(radio => {
                    radio.addEventListener('change', () => this.validateRole());
                });
                
                this.fields.status?.forEach(radio => {
            ...
            validateName() {
                ...
                if (!value) {
                    this.addError(this.fields.name, 'Name is required');
                    return false;
                }
                
                if (value.length < 2) {
                    this.addError(this.fields.name, 'Name must be at least 2 characters');
                    return false;
                }
            ...
            validateEmail() {
                ...
                if (!value) {
                    this.addError(this.fields.email, 'Email is required');
                    return false;
                }
                
                const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                if (!emailRegex.test(value)) {
                    this.addError(this.fields.email, 'Please enter a valid email address');
                    return false;
                }
            ...
            validateRole() {
                const selected = Array.from(this.fields.role).find(r => r.checked);
                this.clearRadioError('role');
                
                if (!selected) {
                    this.addRadioError('role', 'Please select a role');
                    return false;
                }
            ...
            validateStatus() {
                const selected = Array.from(this.fields.status).find(r => r.checked);
                this.clearRadioError('status');
                
                if (!selected) {
                    this.addRadioError('status', 'Please select a status');
                    return false;
                }
            ...
            validateAll() {
                ...
                return nameValid && emailValid && roleValid && statusValid;
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const formValidator = new FormValidator('edit-user-form');
