...
<header class="page-header">
    <div class="page-header-content">
        <div class="welcome-section">
            <h1>
                <span>Welcome back, <?php echo e(auth()->user()->name); ?>!</span>
            </h1>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-card-content">
                <div class="stat-card-value"><?php echo e(number_format((int)($totalCalculations ?? 0))); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-content">
                <div class="stat-card-value">RM <?php echo e(number_format((float)($totalAssetValue ?? 0), 1)); ?>K</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-content">
                <div class="stat-card-value"><?php echo e($lastLogin ?? 'Just now'); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-content">
                <div class="stat-card-value"><?php echo e(auth()->user()->created_at->diffInDays(now())); ?></div>
                ...
                <div class="stat-card-trend">
                    ...
                    Since <?php echo e(auth()->user()->created_at->format('M Y')); ?>
    ...
    <div class="dashboard-grid">
        ...
        <section class="card" aria-labelledby="recentCalcHeading">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('calculator.history')); ?>" class="btn btn-outline btn-sm">
                    View All
                    <span class="icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13 7l5 5-5 5M19 12H5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="card-body no-padding">
                ...
                <?php if($recentCalculations->isNotEmpty()): ?>
                    <div class="table-container" role="region" aria-label="Recent calculations table" tabindex="0">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><strong><?php echo e($calculation->deceased_name ?? 'Unnamed'); ?></strong></td>
                                    <td>RM <?php echo e(number_format((float)($calculation->total_assets ?? 0), 2)); ?></td>
                                    <td><?php echo e($calculation->created_at ? $calculation->created_at->format('d M Y') : 'N/A'); ?></td>
                                    <td>
                                        <?php if(isset($calculation->id) && Route::has('calculator.show')): ?>
                                        <a href="<?php echo e(route('calculator.show', $calculation->id)); ?>" class="btn btn-primary btn-sm" aria-label="View calculation for <?php echo e($calculation->deceased_name ?? 'Unnamed'); ?>">
                                            View
                                        </a>
                                        <?php endif; ?>
                                    </td>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('calculator.index')); ?>" class="btn btn-primary">New Calculation</a>
                    </div>
                <?php endif; ?>
            </div>
        </section>
                ...
                <ul class="activity-list" aria-label="Account overview statistics">
                    <li class="activity-item">
                        ...
                        <div style="font-weight: 700; color: var(--primary);">
                            RM <?php echo e(number_format($calculations->avg('total_assets') ?? 0, 2)); ?>
                    ...
                    <li class="activity-item">
                        ...
                        <div class="activity-time">
                            <?php echo e($calculations->first() ? $calculations->first()->updated_at->diffForHumans() : 'N/A'); ?>
                    ...
                    <li class="activity-item">
                        ...
                        <div style="font-weight: 700; color: var(--gray-700);">
                            <?php echo e(number_format((int)($totalCalculations ?? 0))); ?>
    ...
    <section class="card" style="margin-top: 1.75rem;" aria-labelledby="quickActionsHeading">
        ...
        <div class="card-body">
            <div class="actions-grid">
                <!-- New Calculation -->
                <a href="<?php echo e(route('calculator.index')); ?>" class="action-card">
                ...
                <!-- View History -->
                <a href="<?php echo e(route('calculator.history')); ?>" class="action-card">
                    <div class="action-card-icon" aria-hidden="true">
                        <span class="icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Instant Estate -->
                <a href="<?php echo e(route('instant-estate.index')); ?>" class="action-card">
                    <div class="action-card-icon" aria-hidden="true">
                        <span class="icon">
                ...
                <!-- Estate Planning -->
                <a href="<?php echo e(route('estate-setup.index')); ?>" class="action-card">
                    <div class="action-card-icon" aria-hidden="true">
                        <span class="icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- FAQ & Help -->
                <a href="<?php echo e(route('faq.index')); ?>" class="action-card">
                    <div class="action-card-icon" aria-hidden="true">
                        <span class="icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Give Feedback -->
                <a href="<?php echo e(route('feedback.index')); ?>" class="action-card">
                    <div class="action-card-icon" aria-hidden="true">
                        <span class="icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M12 20h9"/>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if(session('success')): ?> Toast.success("<?php echo e(session('success')); ?>"); <?php endif; ?>
    <?php if(session('error')): ?> Toast.error("<?php echo e(session('error')); ?>"); <?php endif; ?>
    <?php if(session('info')): ?> Toast.info("<?php echo e(session('info')); ?>"); <?php endif; ?>
});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\neo-faraid\resources\views/dashboard.blade.php ENDPATH**/ ?>