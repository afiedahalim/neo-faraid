...
<main class="main-content" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
    ...
    <div class="alert alert-success">
        ...
        <span class="alert-content"><?php echo e(session('success')); ?></span>
    ...
    <div class="alert alert-danger">
        ...
        <span class="alert-content"><?php echo e(session('error')); ?></span>
        <button type="button" class="alert-close">×</button>
    </div>
    <?php endif; ?>
    ...
    <div class="stats-section">
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e($stats['average_rating'] ?? '0.0'); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e($stats['satisfaction_rate'] ?? 0); ?>%</div>
    ...
    <div class="filter-section">
        ...
        <div class="filter-buttons">
            ...
            <?php for($i = 5; $i >= 1; $i--): ?>
            <button class="filter-btn" data-category="<?php echo e($i); ?>-star">
                <svg fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" clip-rule="evenodd"/>
                </svg>
    ...
    <div class="reviews-section">
        <div class="section-header">
            ...
            <div class="reviews-count"><?php echo e($feedback->total() ?? 0); ?> reviews</div>
        </div>
        ...
        <div class="reviews-grid" id="feedback-container">
            ...
            <?php $__currentLoopData = $allFeedback; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="review-card" 
                 data-rating="<?php echo e($item->rating); ?>" 
                 data-date="<?php echo e($item->created_at->timestamp); ?>" 
                 data-top-three="<?php echo e($topFeedback->contains('id', $item->id) ? 'true' : 'false'); ?>">
                
                <?php if($topFeedback->contains('id', $item->id)): ?>
                <div class="top-badge">
                ...
                <div class="review-header">
                    <div class="user-avatar">
                        <?php echo e($item->avatar_initials ?? '??'); ?>

                    </div>
                    <div class="user-info">
                        <h4><?php echo e($item->name ?? 'Anonymous User'); ?></h4>
                        <small><?php echo e($item->email ?? ''); ?></small>
                    </div>
                </div>
                
                <div class="stars">
                    <?php $rating = $item->rating ?? 0; ?>
                    <?php for($i = 1; $i <= 5; $i++): ?>
                    <svg viewBox="0 0 20 20" style="color: <?php echo e($i <= $rating ? '#ffc107' : '#dee2e6'); ?>;">
                ...
                <p class="review-content">
                    "<?php echo e(Str::limit($item->message ?? '', 150)); ?>"
                </p>
                ...
                <div class="review-footer">
                    ...
                    <?php if($item->created_at->diffInDays() < 7): ?>
        ...
        <div class="pagination-wrapper">
            <div class="pagination-info">
                Showing <?php echo e($feedback->firstItem()); ?> to <?php echo e($feedback->lastItem()); ?> of <?php echo e($feedback->total()); ?> reviews
            </div>
            
            <div class="pagination">
                <?php if($feedback->onFirstPage()): ?>
                <span class="page-link disabled">< Previous</span>
                <?php else: ?>
                <a href="<?php echo e($feedback->previousPageUrl()); ?>" class="page-link">< Previous</a>
                <?php endif; ?>
                
                <?php $__currentLoopData = $feedback->getUrlRange(1, $feedback->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($url); ?>" class="page-link <?php echo e($page == $feedback->currentPage() ? 'active' : ''); ?>">
                    <?php echo e($page); ?>

                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                <?php if($feedback->hasMorePages()): ?>
                <a href="<?php echo e($feedback->nextPageUrl()); ?>" class="page-link">Next ></a>
                <?php else: ?>
            ...
            <div class="per-page-select">
                ...
                <select id="perPageSelect">
                    <option value="9" <?php echo e(request('per_page', 9) == 9 ? 'selected' : ''); ?>>9</option>
                    <option value="18" <?php echo e(request('per_page', 9) == 18 ? 'selected' : ''); ?>>18</option>
                    <option value="27" <?php echo e(request('per_page', 9) == 27 ? 'selected' : ''); ?>>27</option>
                </select>
            </div>
        </div>
        <?php endif; ?>
    ...
    <div class="feedback-form-section" id="feedback-form">
        ...
        <?php if(auth()->guard()->check()): ?>
        <form id="feedbackForm" action="<?php echo e(route('feedback.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
