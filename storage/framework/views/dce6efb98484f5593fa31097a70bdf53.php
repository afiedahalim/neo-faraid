...
<body>
    <div class="container">
        ...
        <div class="message">
            <p><?php echo e($message ?? 'The access link you used is invalid or has expired. Please contact the estate administrator for a new link.'); ?></p>
        </div>
        ...
        <div class="help-section">
            ...
            <div class="contact-item">
                <span>📧</span>
                <span>Email: <strong><?php echo e($support_email ?? 'neofaraidadmin@gmail.com'); ?></strong></span>
            </div>
            <div class="contact-item">
                <span>📞</span>
                <span>Phone: <strong><?php echo e($support_phone ?? '+60 1-234-56-7890'); ?></strong></span>
            </div>
        </div>
        ...
        <div class="footer">
            <p>© <?php echo e(date('Y')); ?> Neo Faraid - Islamic Inheritance Calculator. All rights reserved.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\neo-faraid\resources\views/errors/access-denied.blade.php ENDPATH**/ ?>