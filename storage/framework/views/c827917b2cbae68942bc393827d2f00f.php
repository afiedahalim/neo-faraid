...
unset($__errorArgs, $__bag); ?>" placeholder="Enter your full name as per IC/Passport">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nric" type="text" name="nric" value="<?php echo e(old('nric')); ?>" required 
                                   class="form-control <?php $__errorArgs = ['nric'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="000000-00-0000">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <select id="gender" name="gender" required class="form-control <?php $__errorArgs = ['gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Create a strong password">
...
unset($__errorArgs, $__bag); ?>" placeholder="Confirm your password">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input id="contact_phone" type="tel" name="contact_phone" value="<?php echo e(old('contact_phone')); ?>" required 
...
unset($__errorArgs, $__bag); ?>" placeholder="012-3456789">
...
unset($__errorArgs, $__bag); ?>" 
                                  placeholder="Enter your full residential address"><?php echo e(old('address')); ?></textarea>
...
</html><?php /**PATH C:\laragon\www\neo-faraid\resources\views/auth/register.blade.php ENDPATH**/ ?>