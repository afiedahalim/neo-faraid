                ...
                <div class="user-profile-dropdown" id="user-profile-dropdown" role="menu" aria-label="User profile menu" aria-hidden="true">
                    ...
                    <div class="dropdown-section">
                        ...
                        <nav class="dropdown-nav" role="navigation" aria-label="Admin navigation">
                            ...
                            <a href="<?php echo e(route('admin.estate-setup.index')); ?>" class="dropdown-nav-item active">
    ...
    <main class="admin-main">
        <header class="page-header">
            ...
            <div class="header-actions" style="display: flex; gap: 1rem;">
                <a href="<?php echo e(route('admin.estate-setup.export')); ?>" class="btn btn-success">
                ...
                <a href="<?php echo e(route('admin.estate-setup.system-health')); ?>" class="btn btn-info">
        ...
        <div class="stats-cards">
            <div class="stats-card"><div class="stats-card-title">Total Estates</div><div class="stats-card-value"><?php echo e($stats['total'] ?? 0); ?></div></div>
            <div class="stats-card"><div class="stats-card-title">Draft</div><div class="stats-card-value"><?php echo e($stats['draft'] ?? 0); ?></div></div>
            <div class="stats-card"><div class="stats-card-title">Activated</div><div class="stats-card-value"><?php echo e($stats['activated'] ?? 0); ?></div></div>
            <div class="stats-card"><div class="stats-card-title">Admin Approved</div><div class="stats-card-value"><?php echo e($stats['approved'] ?? 0); ?></div></div>
        </div>
        ...
        <div class="search-container">
            <div class="search-box">
                ...
                <input type="text" placeholder="Search by name, NRIC, email, or unique ID..." id="search-input" value="<?php echo e(request('search')); ?>">
            </div>
            <div class="filter-group">
                ...
                <select class="filter-select" id="approval-filter">
                    ...
                    <option value="1" <?php echo e(request('approved') == '1' ? 'selected' : ''); ?>>Approved</option>
                    <option value="0" <?php echo e(request('approved') == '0' ? 'selected' : ''); ?>>Not Approved</option>
                </select>
        ...
        <div class="table-container">
            <?php if(isset($estates) && $estates->count() > 0): ?>
                    ...
                    <table>
                        ...
                        <tbody id="estate-table-body">
                            <?php $__currentLoopData = $estates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <tr class="estate-row"
                                    data-name="<?php echo e(strtolower($estate->deceased_name ?? '')); ?>"
                                    data-user="<?php echo e(strtolower($estate->user->name ?? '')); ?>"
                                    data-unique-id="<?php echo e(strtolower($estate->unique_id ?? '')); ?>"
                                    data-nric="<?php echo e(strtolower($estate->deceased_nric ?? '')); ?>"
                                    data-debts-settled="<?php echo e($allDebtsSettled ? 'true' : 'false'); ?>">
                                    <td><span class="estate-id">#<?php echo e($estate->id); ?></span></td>
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                            <div style="width: 40px; height: 40px; background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; flex-shrink: 0;"><?php echo e($ownerInitials); ?></div>
                                            <div>
                                                <div style="font-weight: 600; color: var(--primary-color);"><?php echo e($estate->user->name ?? 'N/A'); ?></div>
                                                <div style="font-size: 0.85rem; color: var(--text-light);"><?php echo e($estate->user->email ?? 'N/A'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                            <div style="width: 40px; height: 40px; background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; flex-shrink: 0;"><?php echo e($deceasedInitials); ?></div>
                                            <div>
                                                <div style="font-weight: 600; color: var(--primary-color);"><?php echo e($estate->deceased_name); ?></div>
                                                <div style="font-size: 0.85rem; color: var(--text-light);"><?php echo e($estate->deceased_nric ?? 'N/A'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="status-badge status-<?php echo e($estate->status); ?>"><?php echo e($currentStatusLabel); ?></span></td>
                                    <td>
                                        <?php if($estate->admin_approved): ?>
                                    ...
                                    <td>
                                        <?php if($totalDebts > 0): ?>
                                            <span class="<?php echo e($allDebtsSettled ? 'debt-status-settled' : 'debt-status-pending'); ?>">
                                                <?php echo e($debtsSettled); ?>/<?php echo e($totalDebts); ?> settled
                                            </span>
                                            <?php if(!$allDebtsSettled): ?>
                                                <br><small style="color: var(--danger-color);"><?php echo e($unsettledDebts); ?> pending</small>
                                            <?php endif; ?>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div><?php echo e($estate->heirs->count()); ?> heirs</div>
                                        <div><?php echo e($estate->assets->count()); ?> assets</div>
                                    </td>
                                    <td><span>RM <?php echo e(number_format($estate->net_estate, 0)); ?></span></td>
                                    <td>
                                        <div><?php echo e($estate->created_at ? $estate->created_at->format('d M Y') : 'N/A'); ?></div>
                                        <small style="color: var(--text-light)"><?php echo e($estate->created_at ? $estate->created_at->format('H:i') : ''); ?></small>
                                    </td>
                                    <td>
                                        <div class="action-buttons">
                                            <a href="<?php echo e(route('admin.estate-setup.show', $estate->unique_id)); ?>" class="btn-show" style="text-decoration: none;">
                                            ...
                                            <?php if(!$estate->admin_approved && $allDebtsSettled): ?>
                                                <form action="<?php echo e(route('admin.estate-setup.approve', $estate->unique_id)); ?>" method="POST" style="display: inline;" class="approve-form">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="button" class="btn-approve approve-trigger-btn" data-deceased-name="<?php echo e($estate->deceased_name); ?>" data-unique-id="<?php echo e($estate->unique_id); ?>">
                                            ...
                                            <?php elseif(!$estate->admin_approved && !$allDebtsSettled): ?>
                                                <a href="<?php echo e(route('admin.estate-setup.show', $estate->unique_id)); ?>" class="btn-settle-first" style="text-decoration: none;" title="Settle all debts before approving">
                                            ...
                                            <?php else: ?>
                                                <form action="<?php echo e(route('admin.estate-setup.reject', $estate->unique_id)); ?>" method="POST" style="display: inline;" class="reject-form">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="button" class="btn-reject reject-trigger-btn" data-deceased-name="<?php echo e($estate->deceased_name); ?>" data-unique-id="<?php echo e($estate->unique_id); ?>" data-estate-id="<?php echo e($estate->id); ?>">
                                            ...
                                            <form action="<?php echo e(route('admin.estate-setup.toggle-status', $estate->unique_id)); ?>" method="POST" style="display: inline;" class="toggle-form">
                                                <?php echo csrf_field(); ?>
                                                <button type="button" class="btn-toggle toggle-trigger-btn"
                                                        data-deceased-name="<?php echo e($estate->deceased_name); ?>"
                                                        data-unique-id="<?php echo e($estate->unique_id); ?>"
                                                        data-estate-id="<?php echo e($estate->id); ?>"
                                                        data-current-status="<?php echo e($estate->status); ?>"
                                                        data-current-status-label="<?php echo e($currentStatusLabel); ?>"
                                                        data-target-status="<?php echo e($toggleTargetStatus); ?>"
                                                        data-target-status-label="<?php echo e($toggleTargetLabel); ?>">
                ...
                <?php if($estates->hasPages()): ?>
                <div class="pagination-wrapper">
                    <div class="pagination-info">Showing <?php echo e($estates->firstItem()); ?> to <?php echo e($estates->lastItem()); ?> of <?php echo e($estates->total()); ?> estates</div>
                    <div class="pagination">
                        <?php $__currentLoopData = $estates->links()->elements[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $estates->currentPage()): ?>
...
</html><?php /**PATH C:\laragon\www\neo-faraid\resources\views/admin/estate-setup/index.blade.php ENDPATH**/ ?>