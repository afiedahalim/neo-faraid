...
<?php $__env->startSection('title', 'Estate Distribution - ' . ($estate->deceased_name ?? '')); ?>
...
<header class="estate-header">
    ...
    <div class="hero-container">
        ...
        <p class="hero-subtitle">
            View your inheritance details for <?php echo e($estate->deceased_name ?? 'the deceased'); ?>
...
<div class="glass-container">
    ...
    <div class="welcome-card">
        ...
        <div class="welcome-card-content">
            <div>
                <h2 style="font-size: 1.5rem; margin: 0 0 0.25rem;">Welcome, <?php echo e($link->beneficiary_name ?? ($beneficiaryName ?? 'Beneficiary')); ?>!</h2>
                <p style="margin: 0; opacity: 0.9;">You are viewing the estate distribution plan for <strong><?php echo e($estate->deceased_name ?? 'the deceased'); ?></strong>.</p>
            </div>
            <div class="access-badge">
                <div style="font-size: 0.8rem; opacity: 0.8;">Access ID</div>
                <div style="font-weight: 600;"><?php echo e(substr($link->access_token ?? '', 0, 8)); ?>...</div>
            </div>
        </div>
    </div>

    <!-- Debt Settlement Alert -->
    <?php if(isset($debtSummary['all_settled']) && $debtSummary['all_settled']): ?>
    ...
    <?php elseif(isset($debtSummary['total_count']) && $debtSummary['total_count'] > 0): ?>
        <div class="alert-banner warning">
            <div class="alert-banner-content">
                <svg class="alert-banner-icon" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                </svg>
                <span>Debt Settlement Pending: <?php echo e($debtSummary['settled_count'] ?? 0); ?>/<?php echo e($debtSummary['total_count'] ?? 0); ?> debts settled.</span>
            </div>
            <span class="badge badge-warning">Remaining: <?php echo e($debtSummary['formatted_total_remaining'] ?? 'RM 0.00'); ?></span>
        </div>
    <?php endif; ?>
        ...
        <div class="card-body">
            <div class="summary-grid">
                <div class="summary-card">
                    ...
                    <div class="summary-card-value primary">RM <?php echo e(number_format($totalAssets, 2)); ?></div>
                    <div class="summary-card-sub">Properties & Savings</div>
                </div>
                <div class="summary-card">
                    <div class="summary-card-label">Total Debts</div>
                    <div class="summary-card-value danger">RM <?php echo e(number_format($totalDebts, 2)); ?></div>
                    <div class="summary-card-sub">Liabilities</div>
                </div>
                <div class="summary-card">
                    <div class="summary-card-label">Net Estate</div>
                    <div class="summary-card-value success">RM <?php echo e(number_format($netEstate, 2)); ?></div>
                    <div class="summary-card-sub">After Debt Settlement</div>
                </div>
            </div>
            
            <?php if($netEstate > 0 && ($totalWasiyyahPct > 0 || $totalHeirPct > 0)): ?>
                    ...
                    <div class="summary-panel-body">
                        <?php if($totalWasiyyahPct > 0): ?>
                            <div class="summary-item">
                                ...
                                <span class="summary-value"><?php echo e(number_format($totalWasiyyahPct, 2)); ?>% (RM <?php echo e(number_format($wasiyyahAmount, 2)); ?>)</span>
                            </div>
                        <?php endif; ?>
                        <?php if($totalHeirPct > 0): ?>
                            <div class="summary-item">
                                <span class="summary-label">Faraid Heirs Distribution</span>
                                <span class="summary-value success"><?php echo e(number_format($totalHeirPct, 2)); ?>% of Estate After Wasiyyah</span>
                            </div>
                            <div class="summary-total">
                                <div class="summary-item">
                                    <span class="summary-label">Total Estate for Heirs</span>
                                    <span class="summary-value positive">RM <?php echo e(number_format($remainingForHeirs, 2)); ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <div class="glass-card" id="distributionCard">
        <div class="card-header">
            ...
            <span class="card-badge <?php echo e($isHeir ? 'success' : ($isWasiyyah ? 'info' : 'primary')); ?>">
                <?php echo e($isHeir ? 'Faraid Heir' : ($isWasiyyah ? 'Wasiyyah Beneficiary' : ($distribution['type'] === 'trustee' ? 'Trustee' : 'Alternate Trustee'))); ?>
        ...
        <div class="card-body">
            <?php if($isHeir): ?>
                <div class="detail-grid">
                    ...
                    <div class="detail-value"><?php echo e($distribution['name']); ?></div>
                </div>
                <div class="detail-grid">
                    <div class="detail-label">Relationship to Deceased</div>
                    <div class="detail-value"><?php echo e(ucfirst(str_replace('_', ' ', $distribution['relationship']))); ?></div>
                </div>
                <div class="detail-grid">
                    <div class="detail-label">Share Percentage</div>
                    <div class="detail-value"><strong><?php echo e(number_format($distribution['share_percentage'], 2)); ?>%</strong> of Estate After Wasiyyah</div>
                </div>
                <div class="detail-grid" style="background: linear-gradient(135deg, rgba(37,211,102,0.1) 0%, rgba(18,140,126,0.1) 100%);">
                    ...
                    <div class="detail-value highlight"><?php echo e($distribution['formatted_amount']); ?></div>
                </div>
                <?php if($totalHeirPct > 0): ?>
                    <div class="info-card" style="margin-top: 1rem; margin-bottom: 0;">
                        ...
                        <span>Your share represents <strong><?php echo e(number_format($distribution['share_percentage'], 2)); ?>%</strong> of the total faraid distribution pool of <strong>RM <?php echo e(number_format($remainingForHeirs, 2)); ?></strong> (net estate after wasiyyah).</span>
                    </div>
                <?php endif; ?>
            <?php elseif($isWasiyyah): ?>
                <div class="detail-grid">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-value"><?php echo e(ucfirst($distribution['relationship'])); ?></div>
                </div>
                <div class="detail-grid">
                    <div class="detail-label">Requested Percentage</div>
                    <div class="detail-value"><strong><?php echo e(number_format($distribution['requested_percentage'], 2)); ?>%</strong> of Net Estate</div>
                </div>
                <?php if(!empty($distribution['description'])): ?>
                <div class="detail-grid">
                    <div class="detail-label">Notes from Deceased</div>
                    <div class="detail-value"><em><?php echo e($distribution['description']); ?></em></div>
                </div>
                <?php endif; ?>
                <div class="detail-grid" style="background: linear-gradient(135deg, rgba(37,211,102,0.1) 0%, rgba(18,140,126,0.1) 100%);">
                ...
                <div class="info-card" style="margin-top: 1rem; margin-bottom: 0;">
                    ...
                    <span>Wasiyyah cannot exceed 1/3 (33.33%) of net estate. Total wasiyyah: <strong><?php echo e(number_format($totalWasiyyahPct, 2)); ?>%</strong> of RM <?php echo e(number_format($netEstate, 2)); ?>.</span>
                </div>
            <?php elseif($isTrustee): ?>
                <div style="text-align: center; padding: 1rem;">
                    ...
                    <h3 style="margin-bottom: 0.5rem;">You have been appointed as <strong><?php echo e($distribution['role'] ?? 'Trustee'); ?></strong></h3>
                    ...
                    <ul style="text-align: left; display: inline-block; margin-top: 0.5rem;">
                        <?php $__currentLoopData = $distribution['responsibilities'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsibility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li style="margin-bottom: 0.5rem;"><?php echo e($responsibility); ?></li>
    ...
    <div class="glass-card">
        <div class="card-header">
            ...
            <span class="card-badge"><?php echo e(count($heirsList)); ?> Heir(s)</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="results-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong><?php echo e($heir['name']); ?></strong></td>
                            <td><?php echo e(ucfirst(str_replace('_', ' ', $heir['relationship']))); ?></span></td>
                            <td><strong><?php echo e(number_format($heir['percentage'], 2)); ?>%</strong></td>
                            <td style="color: var(--success-color); font-weight: 700;">RM <?php echo e(number_format($heir['amount'], 2)); ?></span></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td><strong><?php echo e(number_format($totalHeirPct, 2)); ?>%</strong></td>
                            <td style="color: var(--primary-color);"><strong>RM <?php echo e(number_format($remainingForHeirs, 2)); ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            <?php if(abs($totalHeirPct - 100) > 0.01 && $totalHeirPct < 100): ?>
                <div class="alert-banner warning" style="margin-top: 1rem; margin-bottom: 0;">
                    <div class="alert-banner-content">
                        <svg class="alert-banner-icon" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                        </svg>
                        <span>Note: Total distribution does not equal 100%. Remaining <?php echo e(number_format(100 - $totalHeirPct, 2)); ?>% will be distributed to Baitulmal (Public Treasury).</span>
                    </div>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div class="glass-card">
        <div class="card-header">
            ...
            <span class="card-badge"><?php echo e(count($wasiyyahList)); ?> Beneficiary(s)</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="results-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(ucfirst($item['relationship'])); ?></span></td>
                            <td><strong><?php echo e(number_format($item['percentage'], 2)); ?>%</strong></td>
                            <td style="color: var(--info-color); font-weight: 700;">RM <?php echo e(number_format($item['amount'], 2)); ?></span></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td><strong><?php echo e(number_format($totalWasiyyahPct, 2)); ?>%</strong></td>
                            <td style="color: var(--primary-color);"><strong>RM <?php echo e(number_format($wasiyyahAmount, 2)); ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            <?php if($totalWasiyyahPct > 33.33): ?>
                <div class="alert-banner warning" style="margin-top: 1rem; margin-bottom: 0;">
                    <div class="alert-banner-content">
                        <svg class="alert-banner-icon" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
    ...
    <?php if(isset($assetsList) && count($assetsList) > 0): ?>
    <div class="glass-card">
        <div class="card-header">
            <svg class="card-header-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="card-badge"><?php echo e(count($assetsList)); ?> Asset(s)</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="results-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>RM <?php echo e(number_format($asset['value'], 2)); ?></td>
                            <td><?php echo e($asset['ownership_percentage']); ?>%</td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td colspan="2"><strong>RM <?php echo e(number_format($totalAssets, 2)); ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    <?php if(isset($debtsList) && count($debtsList) > 0): ?>
    <div class="glass-card">
        <div class="card-header">
            <svg class="card-header-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="card-badge"><?php echo e(count($debtsList)); ?> Debt(s)</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="results-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong><?php echo e($debt['creditor_name']); ?></strong></td>
                            <td><?php echo e($debt['type']); ?></td>
                            <td>RM <?php echo e(number_format($debt['amount'], 2)); ?></td>
                            <td class="<?php echo e($debt['remaining'] > 0 ? 'text-danger' : 'text-success'); ?>">
                                RM <?php echo e(number_format($debt['remaining'], 2)); ?>

                            </td>
                            <td>
                                <span class="badge <?php echo e($debt['remaining'] <= 0 ? 'badge-success' : 'badge-warning'); ?>">
                                    <?php echo e($debt['remaining'] <= 0 ? 'Settled' : 'Pending'); ?>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><strong>RM <?php echo e(number_format($totalDebts, 2)); ?></strong></td>
                            <td colspan="2"><strong>RM <?php echo e(number_format(max(0, $totalDebts - ($debtsPaid ?? 0)), 2)); ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    <div class="glass-card">
        ...
        <div class="card-body">
            <div class="detail-grid">
                ...
                <div class="detail-value"><?php echo e($trusteeName); ?></div>
            </div>
            <div class="detail-grid">
                <div class="detail-label">Contact Email</div>
                <div class="detail-value"><?php echo e($trusteeEmail ?? 'Not provided'); ?></div>
            </div>
            <div class="detail-grid">
                <div class="detail-label">Contact Phone</div>
                <div class="detail-value"><?php echo e($trusteePhone ?? 'Not provided'); ?></div>
            </div>
    ...
    <?php if(isset($hasVideo) && $hasVideo): ?>
    <div class="glass-card">
        <div class="card-header">
            <svg class="card-header-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
        ...
        <div class="card-body">
            <div style="text-align: center;">
                <?php if(isset($willVideoUrl) && $willVideoUrl): ?>
                    <?php if(str_contains($willVideoUrl, 'youtube.com') || str_contains($willVideoUrl, 'youtu.be')): ?>
                        <div style="position: relative; padding-bottom: 56.25%; height: 0; margin-bottom: 1rem;">
                            <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: var(--border-radius-md);" 
                                    src="<?php echo e(str_replace('watch?v=', 'embed/', $willVideoUrl)); ?>" 
                                    frameborder="0" allowfullscreen></iframe>
                        </div>
                        <div class="button-group">
                            <a href="<?php echo e($willVideoUrl); ?>" class="btn btn-video" target="_blank">
                    ...
                    <?php else: ?>
                        <video controls style="width: 100%; max-width: 600px; border-radius: var(--border-radius-md); margin-bottom: 1rem;">
                            <source src="<?php echo e($willVideoUrl); ?>" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <div class="button-group">
                            <a href="<?php echo e($willVideoUrl); ?>" class="btn btn-video" target="_blank" download>
                                <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="pdfContent" style="display:none;">
    <div style="padding:20px;font-family:'Poppins',sans-serif;max-width:800px;margin:0 auto;">
        <div style="text-align:center;margin-bottom:20px;border-bottom:2px solid #1a5fb4;padding-bottom:15px;">
            ...
            <p style="color:#64748b;font-size:12px;margin:0;">Reference: <?php echo e($estate->unique_id ?? 'N/A'); ?> | Status: <?php echo e(ucfirst($estate->status ?? 'N/A')); ?> | Generated: <?php echo e(now()->format('d M Y')); ?></p>
        </div>
        ...
        <table class="pdf-info-table">
            ...
            <tr><td><strong>NRIC</strong></td><td><?php echo e($estate->deceased_nric ?? 'N/A'); ?></td></tr>
            <tr><td><strong>Date of Birth</strong></td><td><?php echo e($estate->date_of_birth ? $estate->date_of_birth->format('d M Y') : 'N/A'); ?></td></tr>
            <tr><td><strong>Date of Death</strong></td><td><?php echo e($estate->date_of_death ? $estate->date_of_death->format('d M Y') : 'N/A'); ?></td></tr>
            <tr><td><strong>Gender</strong></td><td><?php echo e($estate->gender === 'male' ? 'Male' : 'Female'); ?></td></tr>
            <tr><td><strong>Contact</strong></td><td><?php echo e($estate->contact_email ?? 'N/A'); ?> | <?php echo e($estate->contact_phone ?? 'N/A'); ?></td></tr>
        </table>
        ...
        <?php if(isset($assetsList) && count($assetsList) > 0): ?>
            ...
            <table class="pdf-info-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $assetsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr><td><?php echo e($asset['name']); ?></td><td><?php echo e($asset['type']); ?></td><td>RM <?php echo e(number_format($asset['value'], 2)); ?></td><td><?php echo e($asset['ownership_percentage']); ?>%</td></tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background:#f1f5f9;font-weight:700;"><td colspan="2">Total Assets</td><td colspan="2">RM <?php echo e(number_format($totalAssets, 2)); ?></td></tr>
                </tbody>
            </table>
        <?php endif; ?>
        ...
        <?php if(isset($debtsList) && count($debtsList) > 0): ?>
            ...
            <table class="pdf-info-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $debtsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $debt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr><td><?php echo e($debt['creditor_name']); ?></td><td><?php echo e($debt['type']); ?></td><td>RM <?php echo e(number_format($debt['amount'], 2)); ?></td><td>RM <?php echo e(number_format($debt['remaining'], 2)); ?></td></tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background:#f1f5f9;font-weight:700;"><td colspan="2">Total Debts</td><td colspan="2">RM <?php echo e(number_format($totalDebts, 2)); ?></td></tr>
                </tbody>
            </table>
        <?php endif; ?>
        ...
        <?php if(count($heirsList) > 0): ?>
            ...
            <table class="pdf-info-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $heirsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr><td><?php echo e($heir['name']); ?></td><td><?php echo e(ucfirst(str_replace('_', ' ', $heir['relationship']))); ?></td><td><?php echo e(number_format($heir['percentage'], 2)); ?>%</td><td>RM <?php echo e(number_format($heir['amount'], 2)); ?></td></tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background:#f1f5f9;font-weight:700;"><td colspan="2">Total Heirs Share</td><td><?php echo e(number_format($totalHeirPct, 2)); ?>%</td><td>RM <?php echo e(number_format($remainingForHeirs, 2)); ?></td></tr>
                </tbody>
            </table>
        <?php endif; ?>
        ...
        <?php if(count($wasiyyahList) > 0): ?>
            ...
            <table class="pdf-info-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $wasiyyahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr><td><?php echo e($item['name']); ?></td><td><?php echo e(ucfirst($item['relationship'])); ?></td><td><?php echo e(number_format($item['percentage'], 2)); ?>%</td><td>RM <?php echo e(number_format($item['amount'], 2)); ?></td></tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background:#f1f5f9;font-weight:700;"><td colspan="2">Total Wasiyyah</td><td><?php echo e(number_format($totalWasiyyahPct, 2)); ?>%</td><td>RM <?php echo e(number_format($wasiyyahAmount, 2)); ?></td></tr>
                </tbody>
            </table>
        <?php endif; ?>

        <!-- Your Distribution Details - PDF -->
        <?php if($distribution && ($isHeir || $isWasiyyah)): ?>
            <div class="pdf-section-title">Your Distribution Details</div>
            <div class="pdf-info-card" style="background: #e8f1fd;">
                <p><strong>Your Name:</strong> <?php echo e($distribution['name']); ?></p>
                <p><strong>Relationship:</strong> <?php echo e(ucfirst($distribution['type'] === 'heir' ? ucfirst(str_replace('_', ' ', $distribution['relationship'])) : $distribution['relationship'])); ?></p>
                <p><strong>Share Percentage:</strong> <?php echo e(number_format($distribution['type'] === 'heir' ? $distribution['share_percentage'] : $distribution['requested_percentage'], 2)); ?>%</p>
                <p><strong style="color:#25D366;font-size:16px;">Your Inheritance Amount:</strong> <strong style="color:#25D366;font-size:16px;"><?php echo e($distribution['formatted_amount']); ?></strong></p>
            </div>
        <?php endif; ?>
        ...
        <?php if($trusteeName): ?>
            ...
            <table class="pdf-info-table">
                ...
                <tr><td><strong>Phone</strong></td><td><?php echo e($trusteePhone ?? 'Not provided'); ?></td></tr>
            </table>
        <?php endif; ?>

        <div style="margin-top:20px;padding-top:10px;border-top:1px solid #e2e8f0;font-size:10px;color:#94a3b8;text-align:center;">
            <p>This is an official estate distribution statement. Generated on <?php echo e(now()->format('d F Y, h:i A')); ?> | Document ID: <?php echo e($estate->unique_id ?? 'N/A'); ?></p>
        </div>
    </div>
</div>
...
function downloadPDF() {
    ...
    printWindow.document.write(`
        ...
        <html>
        <head>
            <title>Estate Distribution - <?php echo e($estate->deceased_name ?? 'PDF'); ?></title>
            <link rel="preconnect" href="https://fonts.googleapis.com">
            <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
            <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
            <style>
