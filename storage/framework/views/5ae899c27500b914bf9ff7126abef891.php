...
<?php $__env->startSection('title', 'Faraid Calculator'); ?>
...
<header class="hero-section calculator-header">
    ...
    <div class="container hero-container">
        ...
        <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: var(--border-radius-md); padding: 0.75rem 1.5rem; display: inline-flex; align-items: center; gap: 0.75rem; margin-top: 1rem;">
            ...
            <span style="font-size: 0.875rem;">Guest Mode - <a href="<?php echo e(route('login')); ?>" style="color: var(--accent-color); text-decoration: underline;">Login</a> to save calculations</span>
        </div>
        <?php endif; ?>
    </div>
</header>
...
<div class="glass-container">
    ...
    <form id="faraidForm" action="<?php echo e(route('calculator.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        
        <input type="hidden" id="totalAssets" name="total_assets" value="0">
        <input type="hidden" id="deceasedNric" name="deceased_nric" value="<?php echo e(old('deceased_nric')); ?>">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="text" id="deceasedName" name="deceased_name" class="form-input-modern" 
                                       placeholder="Enter full name" required value="<?php echo e(old('deceased_name')); ?>">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <select id="deceasedGender" name="deceased_gender" class="form-input-modern" required>
                                    ...
                                    <option value="male" <?php echo e(old('deceased_gender') == 'male' ? 'selected' : ''); ?>>Male</option>
                                    <option value="female" <?php echo e(old('deceased_gender') == 'female' ? 'selected' : ''); ?>>Female</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="date" id="dateOfDeath" name="date_of_death" class="form-input-modern" 
                                       required value="<?php echo e(old('date_of_death', date('Y-m-d'))); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="text" id="causeOfDeath" name="cause_of_death" class="form-input-modern" 
                                       placeholder="Enter cause of death (if known)" required value="<?php echo e(old('cause_of_death')); ?>">
                                <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                            </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="text" id="deathPlace" name="death_place" class="form-input-modern" 
                                       placeholder="Enter place of death" required value="<?php echo e(old('death_place')); ?>">
                                <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="email" id="contactEmail" name="contact_email" class="form-input-modern" 
                                       placeholder="Enter contact email" required value="<?php echo e(old('contact_email')); ?>">
                                <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="tel" id="contactPhone" name="contact_phone" class="form-input-modern" 
                                       placeholder="Enter contact phone number" required value="<?php echo e(old('contact_phone')); ?>">
                                <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <textarea id="residentialAddress" name="residential_address" class="form-input-modern" 
                                          rows="2" placeholder="Enter full residential address" required><?php echo e(old('residential_address')); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="husbandCount" name="husband_count" class="counter-input" 
                                       value="<?php echo e(old('husband_count', 0)); ?>" min="0" max="1" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="wifeCount" name="wife_count" class="counter-input" 
                                       value="<?php echo e(old('wife_count', 0)); ?>" min="0" max="4" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="sonCount" name="son_count" class="counter-input" 
                                       value="<?php echo e(old('son_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="daughterCount" name="daughter_count" class="counter-input" 
                                       value="<?php echo e(old('daughter_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="fullBrotherCount" name="full_brother_count" class="counter-input" 
                                       value="<?php echo e(old('full_brother_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="fullSisterCount" name="full_sister_count" class="counter-input" 
                                       value="<?php echo e(old('full_sister_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="paternalHalfBrotherCount" name="paternal_half_brother_count" class="counter-input" 
                                       value="<?php echo e(old('paternal_half_brother_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="paternalHalfSisterCount" name="paternal_half_sister_count" class="counter-input" 
                                       value="<?php echo e(old('paternal_half_sister_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="maternalHalfBrotherCount" name="maternal_half_brother_count" class="counter-input" 
                                       value="<?php echo e(old('maternal_half_brother_count', 0)); ?>" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="maternalHalfSisterCount" name="maternal_half_sister_count" class="counter-input" 
                                       value="<?php echo e(old('maternal_half_sister_count', 0)); ?>" min="0" readonly>
                ...
                <div id="resultsContent" style="display: none;">
                    ...
                    <div class="btn-group-modern">
                        ...
                        <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                            ...
                            <a href="<?php echo e(route('calculator.index')); ?>" class="btn btn-ghost">
                                <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                                </svg>
                                Back to List
        ...
        <!-- Hidden Fields -->
        <input type="hidden" id="heirsData" name="heirs_data" value="<?php echo e(old('heirs_data')); ?>">
        <input type="hidden" id="assetsData" name="assets_data" value="<?php echo e(old('assets_data')); ?>">
        <input type="hidden" id="calculationData" name="calculation_data" value="<?php echo e(old('calculation_data')); ?>">
        <input type="hidden" id="scenarioData" name="scenario_data" value="<?php echo e(old('scenario_data')); ?>">
        <input type="hidden" id="chartData" name="chart_data" value="<?php echo e(old('chart_data')); ?>">
        <input type="hidden" id="treeData" name="tree_data" value="<?php echo e(old('tree_data')); ?>">
    </form>
</div>
