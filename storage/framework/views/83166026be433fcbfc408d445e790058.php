<!-- Enhanced Responsive Navigation with Estate Setup Menu - Guest Access for Calculator & Instant Estate -->
<nav class="main-nav" role="navigation" aria-label="Main navigation">
    <div class="nav-container">
        <!-- Logo -->
        <div class="logo">
            <a href="<?php echo e(url('/')); ?>" class="logo-link" aria-label="Neo Faraid Home">
        ...
        <div class="desktop-nav-links">
            ...
            <a href="<?php echo e(url('/')); ?>" 
               class="nav-link white-link <?php echo e(request()->is('/') ? 'active' : ''); ?>"
               data-link="home"
               aria-current="<?php echo e(request()->is('/') ? 'page' : 'false'); ?>">
                <span class="link-text">Home</span>
            </a>
            
            <!-- Instant Estate - PUBLIC ACCESS (No login required) -->
            <a href="<?php echo e(route('instant-estate.index')); ?>" 
               class="nav-link white-link <?php echo e(request()->is('instant-estate*') ? 'active' : ''); ?>"
               data-link="instant-estate"
               aria-current="<?php echo e(request()->is('instant-estate*') ? 'page' : 'false'); ?>">
                <span class="link-text">Instant Estate</span>
            </a>
            
            <!-- Calculator - PUBLIC ACCESS (No login required) -->
            <a href="<?php echo e(route('calculator.index')); ?>" 
               class="nav-link white-link <?php echo e(request()->is('calculator*') && !request()->is('calculator/history') ? 'active' : ''); ?>"
               data-link="calculator"
               aria-current="<?php echo e(request()->is('calculator*') && !request()->is('calculator/history') ? 'page' : 'false'); ?>">
                <span class="link-text">Calculator</span>
            </a>

            <!-- Estate Setup (Pre-Death Registration) - Authenticated Users Only -->
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('estate-setup.index')); ?>" 
                   class="nav-link white-link <?php echo e(request()->is('estate-setup*') ? 'active' : ''); ?>"
                   data-link="estate-setup"
                   aria-current="<?php echo e(request()->is('estate-setup*') ? 'page' : 'false'); ?>">
                    <span class="link-text">Estate Planning</span>
                </a>
            <?php endif; ?>
            
            <!-- FAQ Link -->
            <a href="<?php echo e(route('faq.index')); ?>" 
               class="nav-link white-link <?php echo e(request()->is('faq') ? 'active' : ''); ?>"
               data-link="faq"
               aria-current="<?php echo e(request()->is('faq') ? 'page' : 'false'); ?>">
                <span class="link-text">FAQ</span>
            </a>
            
            <!-- Feedback Link -->
            <a href="<?php echo e(route('feedback.index')); ?>" 
               class="nav-link white-link <?php echo e(request()->is('feedback') ? 'active' : ''); ?>"
               data-link="feedback"
               aria-current="<?php echo e(request()->is('feedback') ? 'page' : 'false'); ?>">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <div class="auth-buttons">
                    <a href="<?php echo e(route('login')); ?>" class="btn-login" aria-label="Login to your account">
                        <svg class="btn-icon" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/>
                        </svg>
                        <span>Login</span>
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="btn-register" aria-label="Create a new account">
                        <svg class="btn-icon" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <?php else: ?>
                ...
                <?php
                    $user = auth()->user();
                    $hasEstateSetup = \App\Models\EstatePreRegistration::where('user_id', $user->id)
                ...
                <div class="user-dropdown-container">
                    <button class="user-dropdown-btn" 
                        ...
                        <span class="user-name-truncated"><?php echo e(Str::limit($user->name, 12)); ?></span>
                    ...
                    <div class="user-dropdown-menu" role="menu" aria-label="User menu">
                        ...
                        <div class="user-profile-summary">
                            ...
                            <div class="user-info">
                                <h4 class="user-fullname"><?php echo e($user->name); ?></h4>
                                <p class="user-email"><?php echo e($user->email); ?></p>
                                <p class="last-login">
                                    <small>Last login: <?php echo e($lastLogin); ?></small>
                                </p>
                                <?php if($user->role === 'admin'): ?>
                        ...
                        <div class="dropdown-section">
                            ...
                            <a href="<?php echo e(route('home')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('/') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('/') ? 'page' : 'false'); ?>">
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('dashboard') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- Estate Planning Tools Section -->
                        <div class="dropdown-section">
                            <h5 class="section-title">Estate Planning</h5>
                            
                            <a href="<?php echo e(route('estate-setup.index')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('estate-setup*') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('estate-setup*') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <div class="dropdown-link-content">
                                    <span class="link-title">Estate Setup</span>
                                    <span class="link-subtitle">Plan your estate while alive</span>
                                </div>
                            </a>
                            
                            <a href="<?php echo e(route('instant-estate.index')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('instant-estate*') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('instant-estate*') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        ...
                        <div class="dropdown-section">
                            ...
                            <a href="<?php echo e(route('calculator.index')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('calculator*') && !request()->is('calculator/history') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('calculator*') && !request()->is('calculator/history') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <a href="<?php echo e(route('calculator.history')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('calculator/history') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('calculator/history') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- Information Section (About, Contact, FAQ, Feedback) -->
                        <div class="dropdown-section">
                            <h5 class="section-title">Information</h5>
                            
                            <a href="<?php echo e(route('about')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('about') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('about') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <div class="dropdown-link-content">
                                    <span class="link-title">About Us</span>
                                    <span class="link-subtitle">Learn about Neo Faraid</span>
                                </div>
                            </a>
                            
                            <a href="<?php echo e(route('contact')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('contact') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('contact') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                                <div class="dropdown-link-content">
                                    <span class="link-title">Contact</span>
                                    <span class="link-subtitle">Get in touch with us</span>
                                </div>
                            </a>
                            
                            <a href="<?php echo e(route('faq.index')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('faq') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('faq') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <div class="dropdown-link-content">
                                    ...
                                    <span class="link-subtitle">Frequently asked questions</span>
                                </div>
                            </a>
                            
                            <a href="<?php echo e(route('feedback.index')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('feedback') ? 'active' : ''); ?>"
                               role="menuitem"
                               aria-current="<?php echo e(request()->is('feedback') ? 'page' : 'false'); ?>">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <div class="dropdown-link-content">
                                    ...
                                    <span class="link-subtitle">Share your thoughts</span>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="dropdown-section">
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" 
                               class="dropdown-link <?php echo e(request()->is('profile*') ? 'active' : ''); ?>" 
                               role="menuitem">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <?php if($user->role === 'admin'): ?>
                            <div class="dropdown-section">
                                ...
                                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                                   class="dropdown-link admin-link <?php echo e(request()->is('admin*') ? 'active' : ''); ?>" 
                                   role="menuitem">
                                    <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <a href="<?php echo e(route('admin.instant-estate.index')); ?>" 
                                   class="dropdown-link admin-link <?php echo e(request()->is('admin/instant-estate*') ? 'active' : ''); ?>" 
                                   role="menuitem">
                                    <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                                    </svg>
        ...
        <div class="mobile-nav-container">
            ...
            <div class="mobile-menu-sidebar" 
                ...
                <div class="mobile-menu-header">
                    <a href="<?php echo e(url('/')); ?>" class="mobile-logo-link" aria-label="Neo Faraid Home">
                ...
                <div class="mobile-menu-content">
                    <?php if(auth()->guard()->guest()): ?>
                        <div class="mobile-auth-section" role="navigation" aria-label="Authentication">
                            <a href="<?php echo e(route('login')); ?>" class="mobile-btn-login" aria-label="Login to your account">
                                <svg class="mobile-btn-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/>
                                </svg>
                                <span>Login</span>
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="mobile-btn-register" aria-label="Create a new account">
                                <svg class="mobile-btn-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                                </svg>
                                <span>Register</span>
                        ...
                        <!-- Mobile Navigation Links for Guests -->
                        <div class="mobile-dashboard-section" role="navigation" aria-label="Main navigation">
                            <div class="mobile-section-header">
                                <span class="mobile-section-title">Quick Links</span>
                            </div>
                            
                            <a href="<?php echo e(route('instant-estate.index')); ?>" 
                               class="mobile-dashboard-link <?php echo e(request()->is('instant-estate*') ? 'active' : ''); ?>"
                               aria-current="<?php echo e(request()->is('instant-estate*') ? 'page' : 'false'); ?>">
                            ...
                            <a href="<?php echo e(route('calculator.index')); ?>" 
                               class="mobile-dashboard-link <?php echo e(request()->is('calculator*') && !request()->is('calculator/history') ? 'active' : ''); ?>"
                               aria-current="<?php echo e(request()->is('calculator*') && !request()->is('calculator/history') ? 'page' : 'false'); ?>">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                                </svg>
                        ...
                        <div class="mobile-info-links">
                            <div class="mobile-section-header">
                                <span class="mobile-section-title">Information</span>
                            </div>
                            
                            <a href="<?php echo e(route('about')); ?>" 
                               class="mobile-user-link <?php echo e(request()->is('about') ? 'active' : ''); ?>">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span>About Us</span>
                            ...
                            <a href="<?php echo e(route('contact')); ?>" 
                               class="mobile-user-link <?php echo e(request()->is('contact') ? 'active' : ''); ?>">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                                <span>Contact</span>
                            ...
                            <a href="<?php echo e(route('faq.index')); ?>" 
                               class="mobile-user-link <?php echo e(request()->is('faq') ? 'active' : ''); ?>">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span>FAQ</span>
                            ...
                            <a href="<?php echo e(route('feedback.index')); ?>" 
                               class="mobile-user-link <?php echo e(request()->is('feedback') ? 'active' : ''); ?>">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>
                                </svg>
                                <span>Feedback</span>
                    ...
                    <?php else: ?>
                        ...
                        <div class="mobile-user-section" role="navigation" aria-label="User account">
                            ...
                            <div class="mobile-dashboard-section" role="navigation" aria-label="My dashboard">
                                ...
                                <a href="<?php echo e(route('dashboard')); ?>" 
                                   class="mobile-dashboard-link <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>"
                                   aria-current="<?php echo e(request()->is('dashboard') ? 'page' : 'false'); ?>">
                                    <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                                    </svg>
                                ...
                                <a href="<?php echo e(route('estate-setup.index')); ?>" 
                                   class="mobile-dashboard-link <?php echo e(request()->is('estate-setup*') ? 'active' : ''); ?>"
                                   aria-current="<?php echo e(request()->is('estate-setup*') ? 'page' : 'false'); ?>">
                                    <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                    </svg>
                                ...
                                <a href="<?php echo e(route('calculator.history')); ?>" 
                                   class="mobile-dashboard-link <?php echo e(request()->is('calculator/history') ? 'active' : ''); ?>"
                                   aria-current="<?php echo e(request()->is('calculator/history') ? 'page' : 'false'); ?>">
                                    <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                            ...
                            <div class="mobile-user-links">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="mobile-user-link <?php echo e(request()->is('profile*') ? 'active' : ''); ?>">
                                    <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    </svg>
                                ...
                                <?php if($user->role === 'admin'): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" 
                                       class="mobile-dashboard-link admin-link <?php echo e(request()->is('admin*') ? 'active' : ''); ?>">
                                        <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                                        </svg>
                                    ...
                                    <a href="<?php echo e(route('admin.instant-estate.index')); ?>" 
                                       class="mobile-dashboard-link admin-link <?php echo e(request()->is('admin/instant-estate*') ? 'active' : ''); ?>">
                                        <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                                        </svg>
                                        <span>Instant Estate Admin</span>
...
.mobile-nav-link-info:hover {
    background: var(--bg-lighter);
    transform: translateX(4px);
    color: var(--primary-blue);
}

.mobile-nav-link-info.active {
    background: linear-gradient(135deg, var(--primary-blue) 0%, var(--secondary-blue) 100%);
    color: white;
}
...
class ResponsiveNavigationManager {
    constructor() {
        this.selectors = {
            ...
            navLinks: '[data-link]',
            mobileNavLinks: '.mobile-nav-link, .mobile-dashboard-link, .mobile-user-link, .mobile-nav-link-info'
        };
    ...
    openUserDropdown() {
        ...
        setTimeout(() => {
            const firstLink = this.elements.userDropdown?.querySelector('a, button, [tabindex]:not([tabindex="-1"])');
    ...
    setActiveLinks() {
        ...
        this.elements.navLinks.forEach(link => {
            ...
            if (linkTarget && (currentPath.includes(linkTarget) || 
                ...
                (linkTarget === 'estate-setup' && currentPath.includes('estate-setup')) ||
                (linkTarget === 'calculator' && currentPath.includes('calculator')) ||
                (linkTarget === 'faq' && currentPath.includes('faq')) ||
                (linkTarget === 'feedback' && currentPath.includes('feedback')))) {
...
</script><?php /**PATH C:\laragon\www\neo-faraid\resources\views/partials/navigation.blade.php ENDPATH**/ ?>