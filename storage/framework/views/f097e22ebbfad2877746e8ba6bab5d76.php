...
<?php $__env->startSection('title', 'Calculation Details'); ?>
...
<header class="hero-section calculation-header">
    ...
    <div class="container hero-container">
        ...
        <p class="hero-subtitle">
            View and manage your saved Faraid calculation for <?php echo e($calculation->deceased_name); ?>

            <?php if($calculation->updated_at->gt($calculation->created_at)): ?>
                <br><small style="opacity: 0.9;">Last updated: <?php echo e($calculation->updated_at->format('d M Y, h:i A')); ?></small>
            <?php endif; ?>
        </p>
    </div>
</header>
...
<div class="glass-container">
    ...
    <?php if(session('updated') || ($calculation->updated_at->gt($calculation->created_at->addMinutes(5)))): ?>
    <div class="update-indicator" id="updateIndicator">
        ...
        <span>
            ...
            <?php else: ?>
                This calculation was last updated on <?php echo e($calculation->updated_at->format('d M Y')); ?>
    ...
    <div class="glass-card active-section" id="overviewSection">
        <div class="card-header">
            ...
            <span class="card-badge">
                <?php echo e($calculation->created_at->format('d M Y')); ?>
        ...
        <div class="card-body">
            ...
            <div class="summary-grid">
                <div class="summary-card">
                    ...
                    <div class="summary-value"><?php echo e($calculation->deceased_name); ?></div>
                    <div class="summary-subtitle"><?php echo e(ucfirst($calculation->deceased_gender)); ?></div>
                </div>
                
                <div class="summary-card">
                    <div class="summary-title">Net Estate</div>
                    <div class="summary-value"><?php echo e($calculation->formatted_net_assets); ?></div>
                    <div class="summary-subtitle">Available for distribution</div>
                </div>
                
                <div class="summary-card">
                    <div class="summary-title">Eligible Heirs</div>
                    <div class="summary-value"><?php echo e($calculation->eligible_heirs_count ?? 0); ?></div>
                    <div class="summary-subtitle">Receive inheritance</div>
                </div>
                
                <div class="summary-card">
                    <div class="summary-title">Date Created</div>
                    <div class="summary-value"><?php echo e($calculation->created_at->format('d M')); ?></div>
                    <div class="summary-subtitle"><?php echo e($calculation->created_at->format('Y')); ?></div>
                </div>
            </div>
            ...
            <div class="distribution-grid">
                <div class="distribution-card">
                    ...
                    <div class="distribution-item">
                        ...
                        <span class="amount"><?php echo e($calculation->formatted_total_assets); ?></span>
                    </div>
                    <div class="distribution-item">
                        <span class="name">Net Assets</span>
                        <span class="amount text-success"><?php echo e($calculation->formatted_net_assets); ?></span>
                    </div>
                </div>
                ...
                <div class="distribution-card">
                    ...
                    <div class="distribution-item">
                        ...
                        <span class="amount"><?php echo e(ucfirst($calculation->marital_status)); ?></span>
                    </div>
                    <div class="distribution-item">
                        <span class="name">Date of Death</span>
                        <span class="amount"><?php echo e($calculation->formatted_date_of_death ?? 'N/A'); ?></span>
                    </div>
                    <div class="distribution-item">
                        <span class="name">Scenario</span>
                        <span class="amount">Scenario <?php echo e($calculation->scenario_number ?? 'N/A'); ?></span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="chart-container">
                        <div class="pie-chart-container">
                            ...
                            <div class="chart-center">
                                ...
                                <div class="chart-center-value" id="eligibleCount"><?php echo e($totalEligible); ?></div>
                        ...
                        <div class="chart-legend" id="overviewChartLegend">
                            ...
                            <div class="legend-item" data-index="<?php echo e($loop->index); ?>">
                                <div class="legend-color" style="background: <?php echo e($item['color'] ?? '#7e1ab4'); ?>;"></div>
                                <div class="legend-text">
                                    <?php echo e($item['heir'] ?? 'Unknown'); ?>

                                    <div class="legend-relationship"><?php echo e($item['relationship'] ?? 'Unknown'); ?></div>
                                    <div class="legend-amount">RM <?php echo e(number_format($item['amount'] ?? 0, 2)); ?></div>
                                </div>
                                <div class="legend-percentage"><?php echo e($item['percentage'] ?? 0); ?>%</div>
                            </div>
                            ...
                            <div class="legend-summary">
                                <div class="legend-item">
                                    ...
                                    <div class="legend-text">
                                        ...
                                        <div class="legend-amount"><?php echo e(count($chartData)); ?> recipient(s)</div>
                                    </div>
                                    <div class="legend-percentage">RM <?php echo e(number_format($totalDistributed, 2)); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="results-container">
                ...
                <table class="results-table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><strong><?php echo e($heirArray['name'] ?? $heirArray['heir'] ?? 'Unknown'); ?></strong></td>
                            <td><span class="badge badge-primary"><?php echo e($heirArray['share'] ?? 'N/A'); ?></span></td>
                    ...
                    <tfoot>
                        <tr class="total-row">
                            ...
                            <td>RM <?php echo e(number_format($totalDistributed, 2)); ?></td>
                            <td>100%</td>
                        </tr>
                    </tfoot>
                </table>
    ...
    <div class="glass-card" id="distributionSection">
        <div class="card-header">
            ...
            <span class="card-badge"><?php echo e($calculation->eligible_heirs_count ?? 0); ?> Eligible Heirs</span>
        </div>
        ...
        <div class="card-body">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $heirs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge <?php echo e($badgeClass); ?>"><?php echo e($heirArray['share'] ?? 'N/A'); ?></span></td>
                                    <td><strong>RM <?php echo e(number_format($amount, 2)); ?></strong></td>
                                    <td><?php echo e(number_format($percentage, 2)); ?>%</td>
                ...
                <?php if(count($eligibleHeirs) > 0): ?>
                    ...
                    <div class="distribution-grid">
                        <div class="distribution-card">
                            ...
                            <?php $__currentLoopData = $topHeirs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $heirArray = is_array($heir) ? $heir : $heir->toArray();
                            ?>
                            <div class="distribution-item">
                                <span class="name"><?php echo e($heirArray['name'] ?? $heirArray['heir'] ?? 'Unknown'); ?></span>
                                <span class="amount">RM <?php echo e(number_format($heirArray['amount'] ?? 0, 2)); ?></span>
                                <span class="share"><?php echo e($heirArray['share'] ?? 'N/A'); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="distribution-card">
                            ...
                            <div class="distribution-item">
                                ...
                                <span class="amount"><?php echo e($totalEligible); ?></span>
                            </div>
                            <div class="distribution-item">
                                <span class="name">Total Distribution</span>
                                <span class="amount">RM <?php echo e(number_format($totalDistributed, 2)); ?></span>
                            </div>
                            <div class="distribution-item">
                                <span class="name">Net Estate</span>
                                <span class="amount">RM <?php echo e(number_format($netEstate, 2)); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="distribution-total">
                        ...
                        <div class="value">RM <?php echo e(number_format($totalDistributed, 2)); ?></div>
                    </div>
                        ...
                        <div class="chart-section">
                            ...
                            <div class="chart-container">
                                <div class="pie-chart-container">
                                    ...
                                    <div class="chart-center">
                                        <div class="chart-center-text">Eligible</div>
                                        <div class="chart-center-value" id="distributionEligibleCount"><?php echo e($totalEligible); ?></div>
                                        <div class="chart-center-text" style="font-size: 0.75rem; margin-top: 0.5rem;">Recipients</div>
                                    </div>
                                </div>
            ...
            <div class="btn-group-modern">
                ...
                <a href="<?php echo e(route('calculator.edit', $calculation->id)); ?>" class="btn btn-warning">
                    <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="distribution-grid">
                <div class="distribution-card">
                    ...
                    <div class="distribution-item">
                        ...
                        <span class="amount"><?php echo e($calculation->deceased_name); ?></span>
                    </div>
                    <div class="distribution-item">
                        <span class="name">Marital Status</span>
                        <span class="amount"><?php echo e(ucfirst($calculation->marital_status)); ?></span>
                    ...
                    <div class="distribution-item">
                        ...
                        <span class="amount"><?php echo e($calculation->total_heirs ?? count($heirs)); ?></span>
                    </div>
                </div>
                ...
                <div class="distribution-card">
                    ...
                    <?php if(count($relationships) > 0): ?>
                        <?php $__currentLoopData = $relationships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationship => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="distribution-item">
                            <span class="name"><?php echo e(ucfirst($relationship)); ?>(s)</span>
                            <span class="amount"><?php echo e($count); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <div class="distribution-item">
    ...
    <div class="glass-card" id="actionsSection">
        ...
        <div class="card-body">
            <!-- Action Cards -->
            <div class="distribution-grid">
                <a href="<?php echo e(route('calculator.edit', $calculation->id)); ?>" class="distribution-card" style="text-decoration: none; color: inherit; display: block;">
                ...
                <form id="deleteForm" action="<?php echo e(route('calculator.destroy', $calculation->id)); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===== CALCULATION DATA =====
    const calculationData = <?php echo json_encode($calculation->toArray(), 15, 512) ?>;
    const distributionSummary = <?php echo json_encode($calculation->distribution_summary ?? [], 15, 512) ?>;
    const treeData = <?php echo json_encode($calculation->tree_data ?? null, 15, 512) ?>;
