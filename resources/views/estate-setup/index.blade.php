...
(function() {
        ...
        for (const h of heirsArr) {
            ...
            resultHtml += `
                <tr>
                    ...
                    <td>${escapeHtml(h.relationship)}</span></td>
                    <td>${h.fraction.num}/${h.fraction.den}</span></td>
    ...
    function updateTotals() {
        ...
        if (tbodyHeirs) {
            if (heirs.length === 0) tbodyHeirs.innerHTML = '<tr><td colspan="5" style="text-align:center;padding:2rem;">No heirs designated yet</span></td>';
            else {
