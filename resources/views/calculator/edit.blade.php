...
@section('title', 'Edit Faraid Calculation')
...
<div class="glass-container">
    ...
    <form id="faraidForm" action="{{ route('calculator.update', $calculation->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        
        <input type="hidden" id="totalAssets" name="total_assets" value="{{ $calculation->total_assets }}">
        <input type="hidden" id="deceasedNric" name="deceased_nric" value="{{ $calculation->deceased_nric }}">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="text" id="deceasedName" name="deceased_name" class="form-input-modern" 
                                       placeholder="Enter full name" required value="{{ old('deceased_name', $calculation->deceased_name) }}">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <select id="deceasedGender" name="deceased_gender" class="form-input-modern" required>
                                    ...
                                    <option value="male" {{ (old('deceased_gender', $calculation->deceased_gender) == 'male') ? 'selected' : '' }}>Male</option>
                                    <option value="female" {{ (old('deceased_gender', $calculation->deceased_gender) == 'female') ? 'selected' : '' }}>Female</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="date" id="dateOfDeath" name="date_of_death" class="form-input-modern" 
                                       required value="{{ old('date_of_death', $calculation->date_of_death ? $calculation->date_of_death->format('Y-m-d') : date('Y-m-d')) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <select id="maritalStatus" name="marital_status" class="form-input-modern" required>
                                    ...
                                    <option value="single" {{ (old('marital_status', $calculation->marital_status) == 'single') ? 'selected' : '' }}>Single</option>
                                    <option value="married" {{ (old('marital_status', $calculation->marital_status) == 'married') ? 'selected' : '' }}>Married</option>
                                    <option value="divorced" {{ (old('marital_status', $calculation->marital_status) == 'divorced') ? 'selected' : '' }}>Divorced</option>
                                    <option value="widowed" {{ (old('marital_status', $calculation->marital_status) == 'widowed') ? 'selected' : '' }}>Widowed</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="text" id="causeOfDeath" name="cause_of_death" class="form-input-modern" 
                                       placeholder="Enter cause of death (if known)" required value="{{ old('cause_of_death', $calculation->cause_of_death) }}">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="text" id="deathPlace" name="death_place" class="form-input-modern" 
                                       placeholder="Enter place of death" required value="{{ old('death_place', $calculation->death_place) }}">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="email" id="contactEmail" name="contact_email" class="form-input-modern" 
                                       placeholder="Enter contact email" required value="{{ old('contact_email', $calculation->contact_email) }}">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <input type="tel" id="contactPhone" name="contact_phone" class="form-input-modern" 
                                       placeholder="Enter contact phone number" required value="{{ old('contact_phone', $calculation->contact_phone) }}">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-group-modern">
                                <textarea id="residentialAddress" name="residential_address" class="form-input-modern" 
                                          rows="2" placeholder="Enter full residential address" required>{{ old('residential_address', $calculation->residential_address) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="glass-card" id="assetsSection">
            <div class="card-header">
                ...
                <span class="card-badge" id="totalAssetsBadge">{{ count($properties) }} {{ count($properties) == 1 ? 'Asset' : 'Assets' }}</span>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="summary-grid">
                    <div class="summary-card">
                        ...
                        <div class="summary-value" id="totalAssetsGrossDisplay">RM {{ number_format(array_sum(array_column($properties, 'value')), 2) }}</div>
                        <div class="summary-subtitle">Sum of all properties</div>
                    </div>
                    
                    <div class="summary-card">
                        <div class="summary-title">Total Assets (Your Share)</div>
                        <div class="summary-value" id="totalAssetsValue">RM {{ number_format(array_sum(array_map(function($p) { return $p['value'] * ($p['ownership'] ?? 100) / 100; }, $properties)), 2) }}</div>
                        <div class="summary-subtitle">After ownership percentage</div>
                    </div>
                    
                    <div class="summary-card">
                        <div class="summary-title">Eligible for Distribution</div>
                        <div class="summary-value text-success" id="netAssets">RM {{ number_format($calculation->net_assets, 2) }}</div>
                    ...
                    <div class="mt-4">
                        <div class="results-container">
                            <table class="results-table">
                                    ...
                                    @if(count($properties) > 0)
                                        @foreach($properties as $index => $prop)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $prop['description'] ?? '-' }}</span></td>
                                                <td><strong>RM {{ number_format($propValue, 2) }}</strong></td>
                                                <td>{{ $ownership }}%</span></td>
                                                <td><strong>RM {{ number_format($share, 2) }}</strong></td>
                                ...
                                <tfoot id="propertiesTotal" style="{{ count($properties) > 0 ? '' : 'display: none;' }}">
                                    <tr style="background: var(--primary-light); font-weight: 600;">
                                        <td colspan="5" style="text-align: right;">Total Assets:</span>
                                        <td id="propertiesTotalValue" colspan="2">RM {{ number_format(array_sum(array_map(function($p) { return $p['value'] * ($p['ownership'] ?? 100) / 100; }, $properties)), 2) }}</span>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <div class="heir-grid">
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="husbandCount" name="husband_count" class="counter-input" 
                                       value="{{ $heirsData['husband_count'] ?? 0 }}" min="0" max="1" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="wifeCount" name="wife_count" class="counter-input" 
                                       value="{{ $heirsData['wife_count'] ?? 0 }}" min="0" max="4" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="status-select">
                                <button type="button" class="status-btn {{ ($heirsData['father_status'] ?? 'deceased') == 'alive' ? 'active' : '' }}" data-target="fatherStatus" data-value="alive">Alive</button>
                                <button type="button" class="status-btn {{ ($heirsData['father_status'] ?? 'deceased') == 'deceased' ? 'active' : '' }}" data-target="fatherStatus" data-value="deceased">Deceased</button>
                            </div>
                            <input type="hidden" id="fatherStatus" name="father_status" value="{{ $heirsData['father_status'] ?? 'deceased' }}">
                        </div>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="counter-hint">Status</div>
                            <div class="status-select">
                                <button type="button" class="status-btn {{ ($heirsData['mother_status'] ?? 'deceased') == 'alive' ? 'active' : '' }}" data-target="motherStatus" data-value="alive">Alive</button>
                                <button type="button" class="status-btn {{ ($heirsData['mother_status'] ?? 'deceased') == 'deceased' ? 'active' : '' }}" data-target="motherStatus" data-value="deceased">Deceased</button>
                            </div>
                            <input type="hidden" id="motherStatus" name="mother_status" value="{{ $heirsData['mother_status'] ?? 'deceased' }}">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="sonCount" name="son_count" class="counter-input" 
                                       value="{{ $heirsData['son_count'] ?? 0 }}" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="daughterCount" name="daughter_count" class="counter-input" 
                                       value="{{ $heirsData['daughter_count'] ?? 0 }}" min="0" readonly>
                ...
                <div class="category-section">
                    ...
                    <div class="heir-grid">
                        <div class="heir-card">
                            ...
                            <div class="status-select">
                                <button type="button" class="status-btn {{ ($heirsData['fathers_father_status'] ?? 'deceased') == 'alive' ? 'active' : '' }}" data-target="fathersFatherStatus" data-value="alive">Alive</button>
                                <button type="button" class="status-btn {{ ($heirsData['fathers_father_status'] ?? 'deceased') == 'deceased' ? 'active' : '' }}" data-target="fathersFatherStatus" data-value="deceased">Deceased</button>
                            </div>
                            <input type="hidden" id="fathersFatherStatus" name="fathers_father_status" value="{{ $heirsData['fathers_father_status'] ?? 'deceased' }}">
                        </div>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="status-select">
                                <button type="button" class="status-btn {{ ($heirsData['fathers_mother_status'] ?? 'deceased') == 'alive' ? 'active' : '' }}" data-target="fathersMotherStatus" data-value="alive">Alive</button>
                                <button type="button" class="status-btn {{ ($heirsData['fathers_mother_status'] ?? 'deceased') == 'deceased' ? 'active' : '' }}" data-target="fathersMotherStatus" data-value="deceased">Deceased</button>
                            </div>
                            <input type="hidden" id="fathersMotherStatus" name="fathers_mother_status" value="{{ $heirsData['fathers_mother_status'] ?? 'deceased' }}">
                        </div>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="status-select">
                                <button type="button" class="status-btn {{ ($heirsData['mothers_mother_status'] ?? 'deceased') == 'alive' ? 'active' : '' }}" data-target="mothersMotherStatus" data-value="alive">Alive</button>
                                <button type="button" class="status-btn {{ ($heirsData['mothers_mother_status'] ?? 'deceased') == 'deceased' ? 'active' : '' }}" data-target="mothersMotherStatus" data-value="deceased">Deceased</button>
                            </div>
                            <input type="hidden" id="mothersMotherStatus" name="mothers_mother_status" value="{{ $heirsData['mothers_mother_status'] ?? 'deceased' }}">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="fullBrotherCount" name="full_brother_count" class="counter-input" 
                                       value="{{ $heirsData['full_brother_count'] ?? 0 }}" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="fullSisterCount" name="full_sister_count" class="counter-input" 
                                       value="{{ $heirsData['full_sister_count'] ?? 0 }}" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="paternalHalfBrotherCount" name="paternal_half_brother_count" class="counter-input" 
                                       value="{{ $heirsData['paternal_half_brother_count'] ?? 0 }}" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="paternalHalfSisterCount" name="paternal_half_sister_count" class="counter-input" 
                                       value="{{ $heirsData['paternal_half_sister_count'] ?? 0 }}" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="maternalHalfBrotherCount" name="maternal_half_brother_count" class="counter-input" 
                                       value="{{ $heirsData['maternal_half_brother_count'] ?? 0 }}" min="0" readonly>
                        ...
                        <div class="heir-card">
                            ...
                            <div class="heir-counter">
                                ...
                                <input type="number" id="maternalHalfSisterCount" name="maternal_half_sister_count" class="counter-input" 
                                       value="{{ $heirsData['maternal_half_sister_count'] ?? 0 }}" min="0" readonly>
        ...
        <div class="glass-card" id="resultsSection">
            ...
            <div class="card-body">
                ...
                <!-- Results Content -->
                <div id="resultsContent" style="{{ !empty($distributionSummary['heirs']) ? 'display: block;' : 'display: none;' }}">
                    <!-- Results Summary -->
                    <div class="summary-grid">
                        <div class="summary-card">
                            <div class="summary-title">Total Heirs</div>
                            <div class="summary-value" id="resultTotalHeirs">{{ $distributionSummary['total_eligible'] ?? 0 }}</div>
                            <div class="summary-subtitle">Eligible for inheritance</div>
                        </div>
                        
                        <div class="summary-card">
                            <div class="summary-title">Total Estate</div>
                            <div class="summary-value" id="resultNetEstate">RM {{ number_format($calculation->net_assets, 2) }}</div>
                            <div class="summary-subtitle">Available for distribution</div>
                        </div>
                        
                        <div class="summary-card">
                            <div class="summary-title">Scenario</div>
                            <div class="summary-value" id="resultScenario">{{ $scenarioNumber }}</div>
                    ...
                    <div class="category-section">
                        <div class="category-header">
                            ...
                            <span class="category-badge" id="scenarioBadge">Scenario {{ $scenarioNumber }}</span>
                        </div>
                        <div id="scenarioDescription" style="margin-top: 1rem; padding: 1.5rem; background: rgba(26, 95, 180, 0.05); border-radius: var(--border-radius-md);">
                            <p id="scenarioText" style="margin: 0; color: var(--gray-700); line-height: 1.6;">{{ $scenarioDescription }}</p>
                        </div>
                    </div>
                            ...
                            <table class="results-table">
                                    ...
                                    @if(count($heirsList) > 0)
                                        @foreach($heirsList as $heir)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ ucfirst($heir['relationship'] ?? 'Unknown') }}</span></td>
                                                <td>{{ $fractionDisplay }}</span></td>
                                                <td><strong>RM {{ number_format($amount, 2) }}</strong></span></td>
                                                <td><strong>{{ number_format($percentage, 2) }}%</strong></span></td>
                                                <td><span class="badge {{ $badgeClass }}">{{ $status }}</span></span></td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                ...
                                <tfoot id="distributionTotal">
                                    <tr class="total-row">
                                        ...
                                        <td id="totalDistributedValue" style="color: white !important;">RM {{ number_format($totalDistributed, 2) }}</span>
                                        <td id="totalPercentageValue" style="color: white !important;">{{ number_format($totalPercentage, 2) }}%</span>
                            ...
                            <div class="chart-container">
                                <div class="pie-chart-container">
                                    ...
                                    <div class="chart-center">
                                        ...
                                        <div class="chart-center-value" id="eligibleCount">{{ $distributionSummary['total_eligible'] ?? 0 }}</div>
                                ...
                                <div class="chart-legend" id="chartLegend">
                                    @php
                                        ...
                                        $colorIndex = 0;
                                    @endphp
                                    @if(count($eligibleHeirsChart) > 0)
                                        @foreach($eligibleHeirsChart as $heir)
                                            @php
                                                $amount = $heir['amount'] ?? 0;
                                                $percentage = $heir['percentage'] ?? ($calculation->net_assets > 0 ? ($amount / $calculation->net_assets) * 100 : 0);
                                            ...
                                            <div class="legend-item" data-index="{{ $loop->index }}">
                                                ...
                                                <div class="legend-text">
                                                    {{ $heir['heir'] ?? $heir['name'] ?? 'Unknown' }}
                                                    <div class="legend-relationship">{{ ucfirst($heir['relationship'] ?? 'Unknown') }}</div>
                                                    <div class="legend-amount">RM {{ number_format($amount, 2) }}</div>
                                                </div>
                                                <div class="legend-percentage">{{ number_format($percentage, 2) }}%</div>
                                            </div>
                                        @endforeach
                                        <div class="legend-summary">
                                            <div class="legend-item">
                                                <div class="legend-color" style="background: var(--primary-color);"></div>
                                                <div class="legend-text"><strong>Total Eligible Distribution</strong><div class="legend-amount">{{ count($eligibleHeirsChart) }} recipient(s)</div></div>
                                                <div class="legend-percentage">RM {{ number_format(array_sum(array_column($eligibleHeirsChart, 'amount')), 2) }}</div>
                                            </div>
                                        </div>
                                    @else
                    ...
                    <div class="btn-group-modern">
                        ...
                        <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                            ...
                            <a href="{{ route('calculator.history') }}" class="btn btn-ghost">
                                <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
                                Back to List
                            </a>
                        </div>
        ...
        <!-- Hidden Fields -->
        <input type="hidden" id="heirsData" name="heirs_data" value="{{ json_encode($heirsData) }}">
        <input type="hidden" id="assetsData" name="assets_data" value="{{ json_encode(['properties' => $properties]) }}">
        <input type="hidden" id="calculationData" name="calculation_data" value="{{ json_encode($calculationData) }}">
        <input type="hidden" id="scenarioData" name="scenario_data" value="{{ json_encode($scenarioData) }}">
        <input type="hidden" id="chartData" name="chart_data" value="{{ json_encode($chartData) }}">
        <input type="hidden" id="treeData" name="tree_data" value="{{ json_encode($treeData) }}">
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let calculationResults = @json($calculationData);
    let detectedScenario = {{ $scenarioNumber }};
    let pieChart = null;
