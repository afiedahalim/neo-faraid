...
<body>
    ...
    <div class="alert-container" id="alert-container">
        @if(session('success'))
        <div class="alert-message alert-success" data-auto-dismiss="2000" data-redirect="{{ route('admin.users.index') }}">
    ...
    <main class="admin-main">
        ...
        <div class="form-container">
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" id="edit-user-form">
                @csrf
                @method('PUT')
