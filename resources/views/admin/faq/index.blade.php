...
<head>
    ...
    <title>Manage FAQ • Neo Faraid Admin</title>
    <meta name="description" content="Manage FAQ entries in Neo Faraid Admin Panel">
...
<body>
    ...
    <main class="admin-main">
        ...
        <header class="page-header">
            <div class="page-title">
                <h1>Manage FAQ</h1>
                <p class="page-subtitle">View and manage frequently asked questions</p>
            </div>
        ...
        <div class="search-container">
            <div class="search-box">
                ...
                <input type="text" placeholder="Search FAQ by question or category..." id="search-input">
            </div>
        </div>
        ...
        <div class="table-container">
            @if($faqs->count() > 0)
                <table>
                    ...
                    <tbody id="faq-table-body">
                        @foreach($faqs as $faq)
                        <tr class="faq-row" data-question="{{ strtolower($faq->question) }}" data-category="{{ strtolower($faq->category) }}" data-id="{{ $faq->id }}">
                            <td>
                                <span style="color: var(--primary-color); font-weight: 600;">#{{ $faq->order }}</span>
                            </td>
                            <td class="faq-question" title="{{ $faq->question }}">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button type="button" class="btn-show show-faq-btn" 
                                            data-faq-id="{{ $faq->id }}"
                                    ...
                                    <a href="{{ route('admin.faq.edit', $faq->id) }}" class="btn-edit">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                        Edit
                                    </a>
                                    <form action="{{ route('admin.faq.destroy', $faq->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn-delete delete-btn" data-faq-id="{{ $faq->id }}" data-faq-question="{{ $faq->question }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="pagination-wrapper">
                    ...
                    <div class="pagination-container">
                        <nav class="pagination" aria-label="Pagination">
                            ...
                            @else
                                <a href="{{ $faqs->previousPageUrl() }}" class="pagination-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                                    </svg>
                                    <span>Previous</span>
                            ...
                            @if($faqs->hasMorePages())
                                <a href="{{ $faqs->nextPageUrl() }}" class="pagination-arrow">
                                    <span>Next</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @else
                <div class="no-data">
                    ...
                    <h3>No FAQ found</h3>
                    <p>There are no FAQ entries to display.</p>
                </div>
            @endif
        </div>
    </main>
    ...
    <!-- FAQ Details Modal -->
    <div id="faqDetailsModal" class="modal-overlay" style="display: none;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="modal-close" id="closeFaqModal">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="20" height="20">
            ...
            <div class="modal-body">
                <div id="faqModalLoading" style="text-align: center; padding: 3rem;">
                    ...
                    <p style="color: var(--text-light);">Loading FAQ details...</p>
                </div>
                <div id="faqModalContent" style="display: none;">
                    <!-- FAQ details will be loaded here dynamically -->
                </div>
                <div id="faqModalError" style="display: none; text-align: center; padding: 3rem; color: var(--danger-color);">
    ...
    <div class="delete-modal-overlay" id="delete-modal">
        <div class="delete-modal">
            ...
            <div class="modal-body-delete">
                ...
                <div class="faq-details-delete">
                    <strong>FAQ Question:</strong>
                    <span id="faq-question-text"></span>
                </div>
                <p><strong>Note:</strong> This will permanently remove the FAQ from the system.</p>
            </div>
    ...
    <script>
        ...
        class FAQManager {
            constructor() {
                ...
                this.faqErrorMessage = document.getElementById('faqErrorMessage');
                ...
                this.faqQuestionText = document.getElementById('faq-question-text');
                this.deleteForms = document.querySelectorAll('.delete-form');
                
                // FAQ data
                this.showButtons = document.querySelectorAll('.show-faq-btn');
                
                // Search elements
                this.searchInput = document.getElementById('search-input');
                this.faqRows = document.querySelectorAll('.faq-row');
            ...
            bindEvents() {
                ...
                this.showButtons.forEach(button => {
                    button.addEventListener('click', () => this.showFaqDetails(button));
                });
                ...
                document.addEventListener('keydown', (e) => {
                    if (e.key === 'Escape' && this.faqModal.style.display === 'flex') {
                        this.closeFaqModal();
                    }
                });
            ...
            showFaqDetails(button) {
                const order = button.getAttribute('data-order');
                const question = button.getAttribute('data-question');
                const answer = button.getAttribute('data-answer');
                const category = button.getAttribute('data-category');
                const categoryLabel = button.getAttribute('data-category-label');
            ...
            showFaqModal(faq) {
                // Show modal
                this.faqModal.style.display = 'flex';
                document.body.style.overflow = 'hidden';
                
                // Show loading initially
                this.faqModalLoading.style.display = 'block';
                this.faqModalContent.style.display = 'none';
                this.faqModalError.style.display = 'none';
                ...
                setTimeout(() => {
                    try {
                        ...
                        const faqHTML = `
                            <div class="faq-detail-grid">
                                ...
                                <div class="detail-group">
                                    ...
                                    <div class="detail-value">${faq.created}</div>
                                </div>
                                
                                <div class="detail-group">
                                    <div class="detail-label">Last Updated</div>
                                    <div class="detail-value">${faq.updated}</div>
                                </div>
                                
                                <div class="faq-content-container">
                                    <div class="detail-label">Question</div>
                                    <div class="faq-question-full">
                                        ${faq.question}
                                    </div>
                                    
                                    <div class="detail-label">Answer</div>
                                    <div class="faq-answer-full">
                                        ${this.formatFAQAnswer(faq.answer)}
                                    </div>
                                </div>
                            </div>
                        `;
                        ...
                        this.faqModalContent.innerHTML = faqHTML;
                        
                        // Hide loading and show content
                        this.faqModalLoading.style.display = 'none';
                        this.faqModalContent.style.display = 'block';
                    } catch (error) {
                        console.error('Error loading FAQ details:', error);
                        this.faqErrorMessage.textContent = 'Error loading FAQ details. Please try again.';
                        this.faqModalLoading.style.display = 'none';
                        this.faqModalError.style.display = 'block';
                    }
                }, 300);
            }
            ...
            getCategoryClass(category) {
                switch(category) {
                    ...
                    case 'securityPrivacy':
                        return 'category-security-privacy';
                    case 'others':
            ...
            formatFAQAnswer(answer) {
                ...
                // Convert newlines to HTML and escape HTML tags
                return answer
                    .replace(/&/g, '&amp;')
                    .replace(/</g, '&lt;')
                    .replace(/>/g, '&gt;')
            ...
            handleDeleteClick(button, index) {
                ...
                this.currentDeleteId = faqId;
                this.faqQuestionText.textContent = question;
            ...
            setupSearch() {
                if (this.searchInput && this.faqRows.length > 0) {
