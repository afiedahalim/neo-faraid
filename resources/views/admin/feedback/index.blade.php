                ...
                <div class="user-profile-dropdown" 
                    ...
                    <div class="dropdown-section">
                        ...
                        <nav class="dropdown-nav" role="navigation" aria-label="Admin navigation">
                            ...
                            <a href="{{ route('admin.feedback.index') }}" class="dropdown-nav-item active">
    ...
    <main class="admin-main">
        ...
        <div class="stats-cards" id="stats-cards">
            <div class="stats-card total-feedback" data-filter="all">
                ...
                <div class="stats-card-value" id="stat-total">{{ $totalFeedback ?? 0 }}</div>
            ...
            <div class="stats-card approved-feedback" data-filter="approved">
                ...
                <div class="stats-card-value" id="stat-approved">{{ $approvedCount ?? 0 }}</div>
            ...
            <div class="stats-card pending-feedback" data-filter="pending">
                ...
                <div class="stats-card-value" id="stat-pending">{{ $pendingCount ?? 0 }}</div>
            ...
            <div class="stats-card rejected-feedback" data-filter="rejected">
                ...
                <div class="stats-card-value" id="stat-rejected">{{ $rejectedCount ?? 0 }}</div>
            ...
            @if($feedbackList->count() > 0)
                <table>
                    ...
                    <tbody id="feedback-table-body">
                        ...
                        <tr class="feedback-row" 
                            data-id="{{ $feedback->id }}"
                            data-name="{{ strtolower($feedback->user->name ?? '') }}" 
                            ...
                            <td>
                                <div class="user-cell">
                                    ...
                                    <div class="user-info">
                                        <span class="user-name-table">{{ $feedback->user->name ?? 'Anonymous' }}</span>
                                        <span class="user-email-table">{{ $feedback->user->email ?? '' }}</span>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button type="button" class="btn-show show-feedback-btn" 
                                            ...
                                            data-user-name="{{ $feedback->user->name ?? 'Anonymous' }}"
                                            data-user-email="{{ $feedback->user->email ?? 'N/A' }}"
                                            data-rating="{{ $feedback->rating }}"
                                            data-message="{{ $feedback->message }}"
                                            data-status="{{ $feedback->status }}"
                                            data-created="{{ $feedback->created_at->format('M d, Y h:i A') }}"
                                    ...
                                    @if($feedback->status != 'approved')
                                        <form action="{{ route('admin.feedback.approve', $feedback->id) }}" method="POST" class="approve-form" style="display: inline;">
                                            @csrf
                                    ...
                                    @if($feedback->status != 'rejected')
                                        <form action="{{ route('admin.feedback.reject', $feedback->id) }}" method="POST" class="reject-form" style="display: inline;">
                                            @csrf
                                    ...
                                    <form action="{{ route('admin.feedback.destroy', $feedback->id) }}" method="POST" class="delete-form" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="pagination-wrapper">
                    <div class="pagination-info">
                        Showing {{ $feedbackList->firstItem() }} to {{ $feedbackList->lastItem() }} of {{ $feedbackList->total() }} results
                    </div>
                    <div class="pagination-container">
                        <nav class="pagination" aria-label="Pagination">
                            ...
                            @else
                                <a href="{{ $feedbackList->previousPageUrl() }}" class="pagination-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                                    </svg>
                                    <span>Previous</span>
                            ...
                            @if($feedbackList->hasMorePages())
                                <a href="{{ $feedbackList->nextPageUrl() }}" class="pagination-arrow">
                                    <span>Next</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
