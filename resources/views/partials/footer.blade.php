        ...
        <div class="footer-main">
            ...
            <div class="footer-links">
                ...
                <ul class="footer-links-list">
                    ...
                    <li><a href="{{ route('instant-estate.index') }}" class="footer-link">Instant Estate</a></li>
                    <li><a href="{{ route('calculator.index') }}" class="footer-link">Calculator</a></li>
                    <li><a href="{{ route('about') }}" class="footer-link">About</a></li>
                    <li><a href="{{ route('contact') }}" class="footer-link">Contact</a></li>
                    <li><a href="{{ route('faq.index') }}" class="footer-link">FAQ</a></li>
                    <li><a href="{{ route('feedback.index') }}" class="footer-link">Feedback</a></li>
            </div>
