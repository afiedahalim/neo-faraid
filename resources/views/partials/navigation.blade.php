...
<nav class="main-nav" role="navigation" aria-label="Main navigation">
    <div class="nav-container">
        ...
        <div class="desktop-nav-links">
            ...
            @auth
                <a href="{{ route('estate-setup.index') }}" 
                   class="nav-link white-link {{ request()->is('estate-setup*') ? 'active' : '' }}"
                   data-link="estate-setup"
                   aria-current="{{ request()->is('estate-setup*') ? 'page' : 'false' }}">
                ...
                <div class="user-dropdown-container">
                    ...
                    <div class="user-dropdown-menu" role="menu" aria-label="User menu">
                        ...
                        <div class="dropdown-section">
                            ...
                            <a href="{{ route('estate-setup.index') }}" 
                               class="dropdown-link {{ request()->is('estate-setup*') ? 'active' : '' }}"
                               role="menuitem"
                               aria-current="{{ request()->is('estate-setup*') ? 'page' : 'false' }}">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div class="dropdown-section">
                            ...
                            <a href="{{ route('about') }}" 
                               class="dropdown-link {{ request()->is('about') ? 'active' : '' }}"
                               role="menuitem"
                            ...
                            <a href="{{ route('contact') }}" 
                               class="dropdown-link {{ request()->is('contact') ? 'active' : '' }}"
                               role="menuitem"
                            ...
                            <a href="{{ route('faq.index') }}" 
                               class="dropdown-link {{ request()->is('faq') ? 'active' : '' }}"
                               role="menuitem"
                               aria-current="{{ request()->is('faq') ? 'page' : 'false' }}">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <a href="{{ route('feedback.index') }}" 
                               class="dropdown-link {{ request()->is('feedback') ? 'active' : '' }}"
                               role="menuitem"
                               aria-current="{{ request()->is('feedback') ? 'page' : 'false' }}">
                                <svg class="link-icon" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div class="mobile-menu-content">
                    @guest
                        ...
                        <div class="mobile-info-links">
                            ...
                            <a href="{{ route('about') }}" 
                               class="mobile-user-link {{ request()->is('about') ? 'active' : '' }}">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span>About Us</span>
                            ...
                            <a href="{{ route('contact') }}" 
                               class="mobile-user-link {{ request()->is('contact') ? 'active' : '' }}">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                                <span>Contact</span>
                            ...
                            <a href="{{ route('faq.index') }}" 
                               class="mobile-user-link {{ request()->is('faq') ? 'active' : '' }}">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span>FAQ</span>
                            ...
                            <a href="{{ route('feedback.index') }}" 
                               class="mobile-user-link {{ request()->is('feedback') ? 'active' : '' }}">
                                <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>
                                </svg>
                                <span>Feedback</span>
                    ...
                    @else
                        ...
                        <div class="mobile-user-section" role="navigation" aria-label="User account">
                            ...
                            <div class="mobile-dashboard-section" role="navigation" aria-label="My dashboard">
                                ...
                                <a href="{{ route('estate-setup.index') }}" 
                                   class="mobile-dashboard-link {{ request()->is('estate-setup*') ? 'active' : '' }}"
                                   aria-current="{{ request()->is('estate-setup*') ? 'page' : 'false' }}">
                                    <svg class="mobile-link-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                    </svg>
