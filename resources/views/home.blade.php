...
@section('title', 'Neo Faraid - Digital Islamic Estate Planning')
...
<header class="hero-section">
    <!-- Animated background -->
    {!! generateAnimatedBackground(['animation_speed' => 'fast']) !!}
    ...
    <div class="container hero-container">
        ...
        <div class="hero-actions">
            <a href="{{ route('estate-setup.index') }}" class="btn btn-primary">
...
<main class="main-content" id="learn-more">
    ...
    <section class="estate-setup-section">
        <div class="estate-steps-container">
            <div class="estate-steps-header">
                ...
                <a href="{{ route('estate-setup.index') }}" class="btn btn-start-setup">
            ...
            <div class="estate-steps-grid">
                ...
                <div class="estate-step-card">
                    <div class="step-header">
                        <span class="step-number-badge">{{ $item['step'] }}</span>
    ...
    <section class="instant-estate-section">
        <div class="instant-estate-container">
            <div class="instant-header">
                ...
                <a href="{{ route('instant-estate.index') }}" class="btn btn-instant">
            ...
            <div class="instant-steps-grid">
                ...
                <div class="instant-step-card">
                    <span class="instant-step-number">{{ $item['step'] }}</span>
                    <h4 class="instant-step-title">{{ $item['title'] }}</h4>
                    <p class="instant-step-desc">{{ $item['desc'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="platform-section">
        ...
        <div class="platform-grid">
            ...
            <div class="platform-card">
                ...
                <h3 class="platform-card-title">{{ $feature['title'] }}</h3>
                <p class="platform-card-desc">{{ $feature['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </section>
        ...
        <div class="calculator-content">
            ...
            <div class="calculator-steps">
                ...
                <div class="calculator-step">
                    <div class="calculator-step-number">{{ $step['num'] }}</div>
                    <div class="calculator-step-title">{{ $step['title'] }}</div>
                </div>
                @endforeach
            </div>
            <div class="text-center">
                <a href="{{ route('calculator.index') }}" class="btn btn-calculator">
    ...
    <section class="share-section">
        ...
        <div class="share-hearts">
            @for($i = 1; $i <= 15; $i++)
            <div class="share-heart heart-{{ $i }}">🧡</div>
            @endfor
        </div>
            ...
            <div class="share-card">
                            ...
                            <div class="country-code-wrapper">
                                <div class="flag-selector">
                                    ...
                                    <select id="country_code" name="country_code" class="country-select">
                                        ...
                                        <option value="{{ $code }}" data-flag="{{ $data[0] }}">{{ $code }} {{ $data[1] }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="alternative-sharing">
                    ...
                    <div class="social-buttons">
                        <a href="https://wa.me/?text={{ urlencode('Check out Neo Faraid - Digital Islamic Estate Planning: ' . url('/')) }}" 
                           target="_blank" 
                        ...
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode('Check out Neo Faraid - Digital Islamic Estate Planning: ' . url('/')) }}" 
                           target="_blank" 
    ...
    <section class="cta-section">
        <div class="cta-container">
            ...
            <div class="cta-buttons">
                <a href="{{ route('estate-setup.index') }}" class="btn btn-cta-primary">
                    <span>Start Estate Planning</span>
                    <svg class="btn-icon" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
                    </svg>
                </a>
                <a href="{{ route('calculator.index') }}" class="btn btn-cta-secondary">
                    <span>Calculate Faraid</span>
                    <svg class="btn-icon" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
                    </svg>
