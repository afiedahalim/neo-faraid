...
<section class="instant-hero">
    ...
    <div class="container hero-container">
        ...
        <div style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); border-radius: var(--border-radius-md); padding: 0.75rem 1.5rem; display: inline-flex; align-items: center; gap: 0.75rem; margin-top: 1rem;">
            ...
            <span style="font-size: 0.875rem;">Guest Mode - <a href="{{ route('login') }}" style="color: var(--accent-color); text-decoration: underline;">Login</a> to request reports via email</span>
        </div>
        @endif
    </div>
</section>
            ...
            <div class="glass-card">
                ...
                <div class="card-body">
                    <div class="upload-zone" id="uploadZone">
                        ...
                        <div class="upload-hint">Supported formats: PDF, JPG, JPEG, PNG, WEBP<br>Maximum file size: {{ $maxFileSize }}MB</div>
                        <input type="file" id="fileInput" class="file-input" accept="{{ $allowedMimeTypes }}">
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const routes = {
        upload: '{{ route("instant-estate.upload") }}',
