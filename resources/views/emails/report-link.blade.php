...
<head>
    ...
    <title>Inheritance Report – {{ $deceased_name }}</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>
                The inheritance distribution report for <strong>{{ $deceased_name }}</strong> has been approved and is now available for your secure viewing.
            </p>

            <!-- Optional share info (if applicable) -->
            @if(!empty($share_percentage))
            <div class="share-info">
                <p style="margin: 0;"><strong>Your Designated Share:</strong> {{ $share_percentage }}% of the distributable estate</p>
            </div>
            @endif
            ...
            <div class="button-wrap">
                <a href="{{ $report_url }}" class="button">View Inheritance Report</a>
            </div>

            <p>Or copy and paste the following link into your browser:</p>
            <p>
                <a href="{{ $report_url }}" style="word-break: break-all;">{{ $report_url }}</a>
            </p>
            ...
            <div class="security-notice">
                ...
                <ul>
                    ...
                    <li>The link will expire on <strong>{{ now()->addDays($expiry_days)->format('d F Y') }}</strong> ({{ $expiry_days }} days from now).</li>
        ...
        <div class="footer">
            ...
            <p class="copy">&copy; {{ date('Y') }} Neo Faraid. All rights reserved.</p>
        </div>
    </div>
</body>
</html>